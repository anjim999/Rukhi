...
export default function AIToolCardGrid({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="p-6 rounded-3xl bg-gradient-to-br from-amber-500/10 via-amber-50/50 to-white dark:via-zinc-900 dark:to-zinc-950 border border-amber-500/40 shadow-2xl hover:border-amber-400 transition-all flex flex-col justify-between group col-span-1 md:col-span-2 lg:col-span-3">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-2xl bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400 group-hover:scale-110 transition-transform">
              <Clapperboard className="w-6 h-6 text-amber-500 dark:text-amber-400" />
            </div>
            <span className="px-3 py-1 rounded-full bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-500/40 text-[10px] font-black uppercase tracking-wider">
              🔥 Flagship AI OS
            </span>
          </div>
          <div>
