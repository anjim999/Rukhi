...
- ⚡ **Google Vertex AI Gemini 2.5 Migration & 72-Hour Storage Fix**: [docs/fixes/VERTEX_AI_GEMINI_AND_72HR_STORAGE_FIX.md](docs/fixes/VERTEX_AI_GEMINI_AND_72HR_STORAGE_FIX.md)
