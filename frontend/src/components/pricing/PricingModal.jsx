...
export default function PricingModal({ isOpen, onClose, user: propUser, onPlanUpgraded }) {
  ...
  const plans = [
    ...
    {
      id: 'starter',
      name: '30s AI Reel Pass',
      price: '₹199',
      period: '/ reel',
      description: '30-Second Consistent Character AI Video Reel',
      exports: '1x 30s AI Reel',
      features: [
        '1x 30-Second AI Video Reel',
        'Consistent Character & Backgrounds',
        '2.5D Parallax & Motion Zoom Sync',
        'AI Voice Sync & Sound Effects',
        'Submagic Kinetic Subtitles (720p HD)',
      ],
      buttonText: 'Get 30s AI Reel (₹199)',
      isCurrent: currentPlan === 'starter' || currentPlan === 'plus',
      popular: true,
    },
    {
      id: 'pro',
      name: '60s AI Reel Pass',
      price: '₹299',
      period: '/ reel',
      description: '60-Second Full AI Video Reel & Multi-Format',
      exports: '1x 60s AI Reel',
      features: [
        '1x 60-Second Full AI Video Reel',
        'Consistent Characters & Story Backgrounds',
        'Multi-Format Switcher (9:16, 16:9, 1:1)',
        'NO Watermark / Custom Logo Upload',
        '1080p Full HD Video Export',
      ],
      buttonText: 'Get 60s AI Reel (₹299)',
