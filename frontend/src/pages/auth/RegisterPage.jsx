      ...
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-3xl shadow-2xl p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500 dark:text-zinc-400">
            Start generating 60FPS broadcast-grade captions and viral reels today.
          </p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-slate-200 dark:border-zinc-700/80 bg-white dark:bg-zinc-800 text-slate-700 dark:text-zinc-200 font-semibold text-sm hover:bg-slate-50 dark:hover:bg-zinc-750 transition shadow-sm"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User className="absolute left-3.5 top-3.5 w-4 h-4 text-slate-400 dark:text-zinc-500" />
              <input
                type="text"
                required
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            />
            <label htmlFor="register-terms" className="text-[11px] text-slate-600 dark:text-zinc-400 cursor-pointer select-none">
